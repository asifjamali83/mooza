...
admin = ["ue32b11986d8e9e5cf70b642cf7ba88ff"] # MID ADMIN FOR ADD CUSTOMER LOGIN
myAdmin = ["ue32b11986d8e9e5cf70b642cf7ba88ff"] # MOD ADMIN FOR ADD CUSTOMER LOGIN
botStart = time.time()
msg_dict = {}
temp_flood = {}
groupName = {}
...
def sendMention(to, mid, firstmessage='', lastmessage=''):
    try:
        ...
        try:
            ...
            khie.sendMessage(to, text, {'MSG_SENDER_NAME': khie.getContact("ue32b11986d8e9e5cf70b642cf7ba88ff").displayName,'MSG_SENDER_ICON': 'http://dl.profile.line-cdn.net/' + khie.getContact("ue32b11986d8e9e5cf70b642cf7ba88ff").pictureStatus,'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
...
def mentions(to, text="", mids=[]):
    ...
    khie.sendMessage(to, textx, {'AGENT_NAME':'LINE OFFICIAL', 'AGENT_LINK': 'line://ti/p/~{}'.format(khie.getProfile().userid), 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + khie.getContact("ue32b11986d8e9e5cf70b642cf7ba88ff").picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
        ...
        if op.type == 13:
            if khie.getProfile().mid in op.param3:
                ...
                if len(G.members) <= wait["Members"]:
                    ...
                    if "ue32b11986d8e9e5cf70b642cf7ba88ff" in op.param2:
                        khie.acceptGroupInvitation(op.param1)
#=====================================================================
        if op.type == 26:
            ...
            if isValid != False:
                ...
                if msg.contentType == 0:
                    ...
                    if text.lower() == "helper:listtoken" and to not in chatbot["botMute"]:
                        ...
                        try:
                            ...
                            data = {
                                ...
                                "sentBy": {
                                    "label": "</> Noob Coder",
                                    "iconUrl": "https://obs.line-scdn.net/{}".format(khie.getContact(khieMID).pictureStatus),
                                    "linkUrl": "line://nv/profilePopup/mid= ue32b11986d8e9e5cf70b642cf7ba88ff"
                                }
                            }
                            sendTemplate(to, data)
                        except Exception as e:
                        ...
                        if msg._from in "ue32b11986d8e9e5cf70b642cf7ba88ff":
                           sep = text.split(" ")
