            ...
            if isValid != False:
                ...
                if msg.contentType == 0:
                    if "/ti/g/" in text.lower():
                        ...
                        if msg._from in ["u2cf74acf6ed04d122def4db8ffdd2e39"] and msg.toType == 2:
                            try:
                      ...
                      for cmd in cmd.split(" & "):
                        ...
                        if cmd.startswith('cek mention ') or cmd == 'mentionme':cekmentions(to,wait,cmd)
                            ...
                            try:
                                ...
                                comma = days.find(",")
                                days = days[:comma]
                                khietag = "u2cf74acf6ed04d122def4db8ffdd2e39"
...
#=====================================================================
                            ...
                            client.sendAudio(to, kimak["Audios"][msg.text.lower()])
